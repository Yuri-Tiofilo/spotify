...
Widget latestAlbuns() {
  return Column(
    children: [
      Row(
        children: [
          miniAbum("images/albumdrake.jpg", "Drake"),
          miniAbum("images/albumpose.jpg", "Poze do Rodo"),
        ],
      ),
      Row(
        children: [
          miniAbum("images/albumkevin.jpg", "Mc Kevin")
          miniAbum("images/albumcesar.jpg", "Cesar mc")
        ],
      ),
      Row(
        children: [
          miniAbum("images/albumdoka.png", "Sidoka"),
          miniAbum("images/albumdex.jpg", "Jovem Dex")
        ],
      ),
    ],
  );
...
Widget newestImage() {
  return ClipRRect(
      child: Image(image: AssetImage("images/cesar.jpg"), width: 60),
      borderRadius: BorderRadius.only(
...
Widget newestAlbumImage() {
  return ClipRRect(
      child: Image(image: AssetImage("images/albumcesar.jpg"), width: 180),
      borderRadius: BorderRadius.only(
...
Widget newestAlbumContent() {
  return Column(
    ...
    children: [
      Container(
        child: Text("Eu precisava voltar com \na Folhinha",
            style: TextStyle(fontWeight: FontWeight.w500, fontSize: 22)),
        margin: EdgeInsets.fromLTRB(10, 0, 5, 10),
      ),
      Container(
        child: Text("Single - Cesar MC",
            style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14)),
        margin: EdgeInsets.fromLTRB(10, 0, 5, 10),
      ),
      Container(
